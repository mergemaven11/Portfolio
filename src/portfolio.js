...
const bigProjects = {
  ...
  projects: [
    { image: "/project-art/bragstack-project.svg", projectName: "Boasted", projectDesc: "Career-proof SaaS for recording evidence-backed accomplishments, measurable impact, skills, and review-ready career material. Demonstrates product modeling, authentication, privacy controls, reporting workflows, automated tests, and containerized local development.", tech: "FastAPI • React/Vite • MongoDB • Docker • GitHub Actions", footerLink: [{ name: "Live Site", url: "https://boasted.io" }, { name: "API Docs", url: "https://api.usebragstack.com/docs" }, { name: "View Source", url: "https://github.com/mergemaven11/bragstack" }] },
