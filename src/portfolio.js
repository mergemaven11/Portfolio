...
const bigProjects = {
  ...
  projects: [
    { image: "https://raw.githubusercontent.com/mergemaven11/Platform-Pocket/main/assets/Platform-pocket-v0.5.png", projectName: "Platform Pocket", projectDesc: "Pocket-sized ESP32-S3 platform-engineering toolkit for the M5Stack Cardputer ADV, combining Wi-Fi diagnostics, defensive security observations, Docker and Compose references, a keyboard-driven local terminal, system utilities, themes, and an evolving SD-backed notes workflow. Built as both a field companion and a heavily documented learning lab for embedded systems and platform engineering.", tech: "C++ • ESP32-S3 • PlatformIO • Arduino • M5Cardputer/M5Unified • Wi-Fi • Embedded UI", footerLink: [{ name: "View Source", url: "https://github.com/mergemaven11/Platform-Pocket" }, { name: "Architecture Docs", url: "https://github.com/mergemaven11/Platform-Pocket/blob/main/docs/architecture.md" }] },
    { image: "/project-art/terraform-infrastructure-lab.svg", projectName: "Terraform Infrastructure Lab", projectDesc: "Interactive infrastructure-as-code learning platform built around a real Docker Terraform lab. Combines a 10-phase curriculum, multi-cloud concept mapping, saved learning progress, architecture visualization, CI validation, and a safe stateful browser CLI that simulates init, validate, plan, apply, output, state, and destroy workflows without cloud credentials or billable infrastructure.", tech: "Terraform • HCL • Docker • GitHub Actions • AWS • Google Cloud • Azure • Kubernetes • Netlify", footerLink: [{ name: "Live Lab", url: "https://terraform-infrastructure-lab.netlify.app/" }, { name: "View Source", url: "https://github.com/mergemaven11/terraform-infrastructure-lab" }] },
    { image: "https://raw.githubusercontent.com/mergemaven11/swift/main/assets/swift.png", projectName: "SwiftFilez", projectDesc: "Production-minded artifact operations CLI with a live in-browser terminal demo. Inspect files, hash artifacts, scan directories concurrently, detect duplicates, build and verify integrity manifests, process CSV/DOCX/PDF content, recursively inspect software artifacts, and explore automation-friendly JSON and exit-code contracts. The browser lab safely simulates the real swf command surface against an isolated demo filesystem, while the actual CLI remains local-first for CI, containers, and platform workflows.", tech: "Python • Typer • Rich • Docker • Browser CLI Demo • CI/CD • Artifact Integrity • Platform Engineering", footerLink: [{ name: "Browser CLI Demo", url: "https://swiftfilez-docs.netlify.app/#browser-lab" }, { name: "View Source", url: "https://github.com/mergemaven11/swift" }] },
    { image: "/project-art/evidencehelix-project.svg", projectName: "EvidenceHelix", projectDesc: "Translational medicine research intelligence platform I am building in part because my mom is sick and I wanted a safer, clearer way to understand the research surrounding serious disease. EvidenceHelix brings biomedical literature, clinical trials, genes and biomarkers, investigated interventions, regulatory data, licensed research datasets, provenance, uncertainty, and evidence-grounded medical AI into one research workspace. It is designed to help people discover what researchers know, what is still being studied, save evidence, compare research directions, and prepare better questions for clinicians — never to diagnose a patient or prescribe treatment.", tech: "Java 21 • Spring Boot • React • TypeScript • Python • FastAPI • MedGemma • PostgreSQL • ClinicalTrials.gov • Europe PMC • NCBI • openFDA • Docker", footerLink: [{ name: "View Source", url: "https://github.com/mergemaven11/EvidenceHelix" }] },
    { image: "/project-art/bragstack-project.svg", projectName: "Boasted", projectDesc: "Career-proof SaaS for recording evidence-backed accomplishments, measurable impact, skills, and review-ready career material. Demonstrates product modeling, authentication, privacy controls, reporting workflows, automated tests, and containerized local development.", tech: "FastAPI • React/Vite • MongoDB • Docker • GitHub Actions", footerLink: [{ name: "Live Site", url: "https://boasted.io/" }, { name: "Career Guides", url: "https://boasted.io/guides" }, { name: "How It Works", url: "https://boasted.io/how-it-works" }, { name: "Customer Docs", url: "https://boasted.io/docs" }] },
    { image: "/project-art/clinly-project.svg", projectName: "Clinly", projectDesc: "Secure professional-participant portal with encrypted messaging, journaling, progress tracking, tenant isolation, audit events, and authorization boundaries. Demonstrates security-conscious backend design and production-minded operational controls.", tech: "React • FastAPI • MongoDB • PyNaCl • Docker", footerLink: [{ name: "View Source", url: "https://github.com/mergemaven11/clinly-backbone" },{ name: "Live Demo", url: "https://clinly-demo.netlify.app/" }] },
    { image: "/project-art/flashquest-project.svg", projectName: "FlashQuest", projectDesc: "Game-like spaced-repetition learning platform with accounts, email verification, private decks, XP, mastery progression, migrations, seed data, readiness checks, and CI quality gates.", tech: "React • FastAPI • PostgreSQL • Alembic • Docker", footerLink: [{ name: "Live Demo", url: "https://flashquestt.netlify.app/" }, { name: "View Source", url: "https://github.com/mergemaven11/FlashQuest" }] },
    { image: "/project-art/variant-vault-project.svg", projectName: "Variant Vault", projectDesc: "Private collector operating system for organizing, documenting, valuing, and protecting physical collections. Built around multi-tenant ownership data, category-aware inventory, Smart CSV import, barcode/OCR-assisted capture, cache-first market estimates, analytics, portable backups, and insurance-ready ownership documentation.", tech: "Python • Streamlit • PostgreSQL • SQLAlchemy • Alembic • Docker • Kubernetes • GitHub Actions", footerLink: [{ name: "View Source", url: "https://github.com/mergemaven11/variant-vault" }] },
    { image: "/project-art/ai-research-lab-project.svg", projectName: "AI Research Lab", projectDesc: "Visual, hands-on 12-week AI systems curriculum built as a real learning platform instead of a static syllabus. Includes 120 guided lessons, Mermaid diagrams, AI-specific Three.js concept demos, knowledge checks, gated labs and homework, local progress tracking, and production deployment through Netlify.", tech: "JavaScript • Three.js • Mermaid.js • Learning UX • AI Systems • Netlify", footerLink: [{ name: "Live Course", url: "https://ai-research-qhx4.netlify.app/" }, { name: "View Source", url: "https://github.com/mergemaven11/ai-research" }] },
  ], display: true,
};
