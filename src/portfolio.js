...
const bigProjects = {
  ...
  projects: [
    ...
    { image: "/project-art/evidencehelix-project.svg", projectName: "EvidenceHelix", projectDesc: "Translational medicine research intelligence platform I am building in part because my mom is sick and I wanted a safer, clearer way to understand the research surrounding serious disease. EvidenceHelix brings biomedical literature, clinical trials, genes and biomarkers, investigated interventions, regulatory data, licensed research datasets, provenance, uncertainty, and evidence-grounded medical AI into one research workspace. It is designed to help people discover what researchers know, what is still being studied, save evidence, compare research directions, and prepare better questions for clinicians — never to diagnose a patient or prescribe treatment.", tech: "Java 21 • Spring Boot • React • TypeScript • Python • FastAPI • MedGemma • PostgreSQL • ClinicalTrials.gov • Europe PMC • NCBI • openFDA • Docker", footerLink: [] },
