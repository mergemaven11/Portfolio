...
const bigProjects = {
  ...
  projects: [
    ...
    { image: "https://raw.githubusercontent.com/mergemaven11/swift/main/assets/swift.png", projectName: "SwiftFilez", projectDesc: "Production-minded artifact operations CLI for inspecting files, hashing artifacts, scanning directories concurrently, detecting duplicates, building integrity manifests, validating drift, processing CSV/DOCX/PDF content, and exposing automation-friendly JSON and exit-code contracts. Designed for local use, CI pipelines, containers, and platform workflows.", tech: "Python • Typer • Rich • Docker • CLI • CI/CD • Artifact Integrity • Platform Engineering", footerLink: [{ name: "Live Docs", url: "https://swiftfilez-docs.netlify.app/" }, { name: "View Source", url: "https://github.com/mergemaven11/swift" }] },
